    ...
    <div class="pagination">
        ...
        <?php
            ...
            if(!empty($paging_data) && $paging_data['TOTAL_RECORDS'] > 0)
            {
                    ...
                    {
                        ?>
                        <a href="<?php echo $paging_data['PREVIOUS_PAGE_URL']?>" onclick="<?php echo $paging_data['PREVIOUS_PAGE_ONCLICK']; ?>" title="Previous"><img src="images/prev.png" alt="Prev" /></a>
                        <?php
                    ...
                    {
                        ?>
                        <a href="<?php echo $paging_data['NEXT_PAGE_URL']?>" onclick="<?php echo $paging_data['NEXT_PAGE_ONCLICK']?>" title="Next"><img src="images/next.png" alt="Next" /></a>
                       <?php
                    }
