...
class Faq_model extends Base_Model {
    ...
    function get_record_listing()
    {
        ...
        {
            $this->db->like("LOWER(R.question)", strtolower($this->search_term));
        }
        ...
        $this->db->select('R.*');
        $this->db->from($this->_tbl_faq.' AS R');
        $query  = $this->db->get();
    ...
    public function save_record($data)
    {
        ...
        {
            $this->db->where('id', $id);
            $this->db->update($this->_tbl_faq, $data);
            $id = $id;
        } else
        {
            $this->db->set('created', 'NOW()', FALSE);
            $this->db->insert($this->_tbl_faq, $data);
    ...
    public function delete_record($id)
    {
        ...
        $this->db->where('id', $id);
        return $this->db->delete($this->_tbl_faq);
    }
}
?>