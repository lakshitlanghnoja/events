    ...
    <div class="main-container">
        <div class="search-box">
            <table cellspacing="2" cellpadding="4" border="0">
                ...
                <td align="right">Search by Permission Title :</td>
                <td align="left">
                    <?php
                    $input_data = array(
                        'name' => 'search_term',
        ...
        <div class="grid-data grid-data-table">
            <div class="add-new">
                ...
                <?php echo anchor(site_url().get_current_section($this).'/permissions/action/add', lang('add-permission'), 'title="Add Permission" style="text-align:center;width:100%;"'); ?>
            </div>
                    ...
                    if (!empty($permissions))
                    {
                        ...
                        foreach ($permissions as $permission)
                        {
                            ...
                            <tr class="<?php echo $class; ?> rows" id="row-<?php echo $permission['P']['id']; ?>">
                                <td><input type="checkbox" id="<?php echo $permission['P']['id']; ?>" name="check_box[]" class="check_box" value="<?php echo $permission['P']['id']; ?>"></td>
                                <td><?php echo $i; ?></td>
                    ...
                    else
                    {
                        echo add_image(array('inactive.png'), '', '', array('title'=>'inactive','alt' =>"inactive"));
                            ...
                            ?></td>
                                <td>
                                    <div class="action">
                                        <div style="float:left;padding-right:10px;"><a title='View' href="<?php echo site_url().get_current_section($this);?>/permissions/view_data/<?php echo $permission['P']['id'] ?>"><?php echo  add_image(array('viewIcon.png')); ?></a></div>
                                        <div class="edit"><a href="<?php echo site_url().get_current_section($this); ?>/permissions/action/edit/<?php echo $permission['P']['id'] ?>" title="<?php echo lang('edit') ?>"><?php echo add_image(array('edit.png')); ?></a></div>
                                        <?php
                                        $permission_id = $permission['P']['id'];
                                        $deletelink = "<a href='javascript:;' title='Delete' onclick='delete_permission($permission_id)'>" . add_image(array('delete.png')) . "</a>";
                                        ?>
